(self.webpackChunkapp_studio_enterprise_schema_view=self.webpackChunkapp_studio_enterprise_schema_view||[]).push([[3851,3802],{53802:(f,c,s)=>{s.r(c),s.d(c,{CrtIFrameComponent:()=>o,CrtIFrameModule:()=>l});var n=s(74742),d=s(31134),a=s(75378),r=s(94450);const u=`
::-webkit-scrollbar {
	width: 6px;
	height: 8px;
}
