namespace IntegrationV2.Files.cs.Domains.MeetingDomain.Repository
{
	...
	public class CalendarRepository : ICalendarRepository
	{
		...
		private bool GetUseImpersonation(Mailbox mailbox) {
			var synchCreds = mailbox.ConvertToSynchronizationCredentials(_userConnection, true);
			if (!synchCreds.FeatureValues.ContainsKey("UseImpersonation")) {
				return false;
			}
			return synchCreds.FeatureValues["UseImpersonation"];
		}
